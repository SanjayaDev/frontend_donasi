    ...
    <header>
      <div class="bg-gray-700 text-white text-center fixed inset-x-0 top-0 z-10">
        ...
        <div class="col-span-8">
            <input type="text" v-model="search" @keyup="searchQuery" @click="linkToSearch" class="appearance-none w-full bg-gray-500 rounded-full h-7 shadow-md placeholder-white focus:outline-none focus:placeholder-gray-600 focus:bg-white focus-within:text-gray-600 p-5"
